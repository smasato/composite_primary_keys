...
GitHub Actions build status: {rdoc-image:https://github.com/composite-primary-keys/composite_primary_keys/actions/workflows/mariadb.yml/badge.svg?branch=master}[https://github.com/composite-primary-keys/composite_primary_keys/actions/workflows/mariadb.yml?query=branch=master]
GitHub Actions build status: {rdoc-image:https://github.com/composite-primary-keys/composite_primary_keys/actions/workflows/mysql   .yml/badge.svg?branch=master}[https://github.com/composite-primary-keys/composite_primary_keys/actions/workflows/mqsql.yml?query=branch=master]
=== Oracle
...
GitHub Actions build status: {rdoc-image:https://github.com/composite-primary-keys/composite_primary_keys/actions/workflows/postgresql.yml/badge.svg?branch=master}[https://github.com/composite-primary-keys/composite_primary_keys/actions/workflows/postgresql.yml?query=branch=master]
...
GitHub Actions build status: {rdoc-image:https://github.com/composite-primary-keys/composite_primary_keys/actions/workflows/sqlite.yml/badge.svg?branch=master}[https://github.com/composite-primary-keys/composite_primary_keys/actions/workflows/sqlite.yml?query=branch=master]
